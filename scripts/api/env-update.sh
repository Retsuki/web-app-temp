...
echo -e "${BLUE}=== API Environment Variables Update (Secret Manager) ===${NC}"
...
echo -e "${YELLOW}gcloud run services update api --set-secrets=/path/to/mount=$SECRET_NAME:latest${NC}"