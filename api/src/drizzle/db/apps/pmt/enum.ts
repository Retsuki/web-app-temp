...
export type PostScheduleType =
	(typeof POST_SCHEDULE_TYPES)[keyof typeof POST_SCHEDULE_TYPES];
...
export const postTypeEnum = pgEnum(
	"post_type",
	Object.values(POST_TYPES) as [string, ...string[]],
);
...
export type PostTargetStatus =
	(typeof POST_TARGET_STATUSES)[keyof typeof POST_TARGET_STATUSES];
...
export const platformEnum = pgEnum(
	"platform",
	Object.values(PLATFORMS) as [string, ...string[]],
);
