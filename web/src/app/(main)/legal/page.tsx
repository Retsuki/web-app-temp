        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <table className="w-full border-collapse">
            <tbody>
              ...
              <tr className="border-b">
                <th className="text-left p-4 w-1/3 bg-gray-50 dark:bg-gray-800">商品代金以外の必要料金</th>
                <td className="p-4">
                  なし<br />
              ...
              <tr className="border-b">
                ...
                <td className="p-4">
                  クレジットカード：ご注文時に決済されます
                </td>
              </tr>
              <tr className="border-b">
                <th className="text-left p-4 w-1/3 bg-gray-50 dark:bg-gray-800">商品の引き渡し時期</th>
                <td className="p-4">
                  デジタルコンテンツ：決済完了後、即時利用可能<br />
                  サブスクリプション：決済完了後、即時利用可能
                </td>
              </tr>
              <tr className="border-b">
                <th className="text-left p-4 w-1/3 bg-gray-50 dark:bg-gray-800">返品・交換について</th>
                <td className="p-4">
                  デジタルコンテンツの性質上、返品・交換はお受けできません。<br />
              ...
              <tr className="border-b">
                ...
                <td className="p-4">
                  サブスクリプションサービスは、マイページよりいつでも解約可能です。<br />
